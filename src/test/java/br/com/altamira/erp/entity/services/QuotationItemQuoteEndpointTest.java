...
public class QuotationItemQuoteEndpointTest {
	...
	@Inject
	private QuotationItemQuoteEndpoint quotationitemquoteendpoint;
	...
	public static JavaArchive createDeployment() {
		return ShrinkWrap
				...
				.addClasses(QuotationItemQuoteEndpoint.class, Material.class,
	...
	public void should_be_deployed() {
		Assert.assertNotNull(quotationitemquoteendpoint);
	}
	...
	public void testListAll() {
		Assert.assertFalse(quotationitemquoteendpoint.listAll(1, 1).isEmpty());
	}
