...
public class RequestItemEndpointTest {
	...
	@Inject
	private RequestItemEndpoint requestitemendpoint;
	...
	public static JavaArchive createDeployment() {
		return ShrinkWrap
				...
				.addClasses(RequestItemEndpoint.class, Material.class,
	...
	public void should_be_deployed() {
		Assert.assertNotNull(requestitemendpoint);
	}
	...
	public void testListAll() {
		Assert.assertFalse(requestitemendpoint.listAll(1, 1).isEmpty());
	}
