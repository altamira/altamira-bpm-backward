...
public class SupplierContactEndpointTest {

	@Inject
	private SupplierContactEndpoint suppliercontactendpoint;
	...
	public void should_be_deployed() {
		Assert.assertNotNull(suppliercontactendpoint);
	}
	...
	public void testListAll() {
		Assert.assertFalse(suppliercontactendpoint.listAll(1, 1).isEmpty());
	}
