...
public class PurchaseOrderEndpoint
{
   ...
   {
      TypedQuery<PurchaseOrder> findByIdQuery = em.createQuery("SELECT DISTINCT p FROM PurchaseOrder p LEFT JOIN FETCH p.supplier LEFT JOIN FETCH p.purchasePlanning LEFT JOIN FETCH p.purchaseOrderItemSet WHERE p.id = :entityId ORDER BY p.id", PurchaseOrder.class);
   ...
   {
      TypedQuery<PurchaseOrder> findAllQuery = em.createQuery("SELECT DISTINCT p FROM PurchaseOrder p LEFT JOIN FETCH p.supplier LEFT JOIN FETCH p.purchasePlanning LEFT JOIN FETCH p.purchaseOrderItemSet ORDER BY p.id", PurchaseOrder.class);
