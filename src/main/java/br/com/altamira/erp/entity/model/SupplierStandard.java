...
public class SupplierStandard implements Serializable {
    ...
    public SupplierStandard(SupplierStandardPK supplierStandardPK, Character available) {
        this.supplierStandardPK = supplierStandardPK;
    ...
    public boolean equals(Object object) {
        ...
        if ((this.supplierStandardPK == null && other.supplierStandardPK != null) || (this.supplierStandardPK != null && !this.supplierStandardPK.equals(other.supplierStandardPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "br.com.altamira.erp.entity.model.SupplierStandard[ supplierStandardPK=" + supplierStandardPK + " ]";
    }
